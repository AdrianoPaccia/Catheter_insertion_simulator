...
mode = 1 #modality of force approximation
...
object_pose = {'dx':670.0, 'dy':20.0, 'dz':3.0, 'rx':0.0, 'ry':175.0, 'rz':175.0}     #terzo canale - scale=1.5
...
def createScene(root):
    ...
    veinsNode.addObject('MeshSTLLoader', name='loader', filename='mesh/cephalicVein.stl',  flipNormals="1", triangulate="1")
    ...
    veinsNode.addObject('OglModel', name='Visual', src='@loader', color='1 0 0 0.5',
    dx=object_pose['dx'], dy=object_pose['dy'], dz=object_pose['dz'], 
    rx=object_pose['rx'], ry=object_pose['ry'],rz=object_pose['rz'], scale = 1.5)
