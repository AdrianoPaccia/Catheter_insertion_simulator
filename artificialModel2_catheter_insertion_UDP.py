...
object_pose = {'dx':285.0, 'dy':-2.0, 'dz':-4.0, 'rx':90.0, 'ry':0.0, 'rz':0.0}    
...
def createScene(root):
    ...
    veinsNode.addObject('MeshOBJLoader', name='loader', filename='mesh/vessel2.obj',  flipNormals="1", triangulate="1")
