...
# enter on a side, slightly angled [veins]
#object_pose = {'dx':1370, 'dy':40.0, 'dz':3.0, 'rx':0.0, 'ry':175.0, 'rz':175.0}   #penultimo canale - scale=3 
object_pose = {'dx':300.0, 'dy':-22.0, 'dz':-40.0, 'rx':90.0, 'ry':110.0, 'rz':-27.0}     #terzo canale - scale=1.5

controller_vars = {'movement_incr_mm':0.1, 'rotation_incr_degrees':10, 'dt':0.01}
...
def createScene(root):
    ...
    root.addObject('VisualStyle', displayFlags='showInteractionForceFields showCollisionModels hideBoundingCollisionModels showForceFields')
    ...
    FEMNode.addObject('MeshMatrixMass',name='mass', massDensity=realDensity)#catheter_vars['massDensity'])
